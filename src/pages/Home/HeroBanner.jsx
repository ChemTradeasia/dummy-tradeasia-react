export default function HeroBanner() {
  return (
    <section className="relative w-full pt-[50px] pb-[100px] md:pt-[95px] md:pb-[180px] overflow-hidden">
      <img
      ...
      <div className="relative z-10 container mx-auto h-full flex items-center px-4 md:px-3 md:py-0 sm:py-12 sm:text-[30px]">
        <div className="w-full md:w-7/12">
          <div>
            <h1 className="text-white text-[32px] md:text-[50px] font-semibold leading-tight md:leading-normal">
