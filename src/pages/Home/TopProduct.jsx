export default function TopProduct() {
  return (
    <section className="container mx-auto">
      <div className="md:p-[50px] md:pt-[45px] sm:p-[20px] bg-[#fefaef]">
        <div className="">
          <div className="grid grid-cols-1 md:grid-cols-13 items-center">
            ...
            <div className="md:col-span-7 md:pl-25 ml-10 sm:pl-0 sm:ml-0 sm:mt-5">
              <h5 className="text-[var(--color-light-blue)] font-semibold text-[24px] md:text-[24px] sm:text-[18px]">Our Products</h5>
              <h3 className="text-2xl md:text-[44px] font-semibold leading-normal sm:text-[18px]">
                Product Range of Soda Ash Dense
              </h3>
              <p className="leading-[29px] mb-6 sm:text-[16px] sm:leading-[25px]">
              ...
              <a
                href="/products"
                className="inline-block mt-4 bg-[var(--color-light-blue)] text-white font-medium sm:px-5 sm:py-2.5 rounded-full md:px-7 md:py-3 md:text-[16px] hover:bg-[var(--color-header-bg)] transition-all sm:text-[14px] "
              >
                Explore Our Product
              </a>
            </div>
